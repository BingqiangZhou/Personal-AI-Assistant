"""Application services for Celery/task orchestration."""
...
class PodcastTaskOrchestrationService:
    """Shared orchestration for background task handlers."""
    ...
    async def process_audio_transcription_task(
        ...
        *,
        ...
        """Execute transcription with distributed lock + state updates."""
