...
class _ApiServices implements ApiServices {
  ...
  Future<PaginatedResponse<KnowledgeItemModel>> getKnowledgeItems({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaginatedResponse<KnowledgeItemModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/knowledge/items',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PaginatedResponse<KnowledgeItemModel> _value;
    try {
      _value = PaginatedResponse<KnowledgeItemModel>.fromJson(
        _result.data!,
        (json) => KnowledgeItemModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
  ...
  Future<KnowledgeItemModel> createKnowledgeItem(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request);
    final _options = _setStreamType<KnowledgeItemModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/knowledge/items',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late KnowledgeItemModel _value;
    try {
      _value = KnowledgeItemModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, _result);
      rethrow;
    }
  ...
  @override
  Future<KnowledgeItemModel> getKnowledgeItem(String itemId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  Future<SearchResponse<KnowledgeItemModel>> searchKnowledge(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(request);
    final _options = _setStreamType<SearchResponse<KnowledgeItemModel>>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/knowledge/search',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late SearchResponse<KnowledgeItemModel> _value;
    try {
      _value = SearchResponse<KnowledgeItemModel>.fromJson(
        _result.data!,
        (json) => KnowledgeItemModel.fromJson(json as Map<String, dynamic>),
      );
    } on Object catch (e, s) {
  ...
  Future<PaginatedResponse<SubscriptionModel>> getSubscriptions({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<PaginatedResponse<SubscriptionModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/subscriptions',
  ...
  @override
  Future<Map<String, dynamic>> processFile(Map<String, dynamic> request) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
