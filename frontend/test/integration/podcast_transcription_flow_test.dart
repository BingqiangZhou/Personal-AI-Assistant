...
void main() {
  group('Podcast Transcription Flow - End to End Tests', () {
    testWidgets('User Journey: Start transcription and see progress through all stages',
      ...
      expect(find.text('Start Transcription'), findsNWidgets(2)); // Title + Button
    ...
    testWidgets('Error Journey: Transcription fails with network error and user retries',
        (WidgetTester tester) async {
    ...
    testWidgets('User Journey: Server restart during transcription', (WidgetTester tester) async {
    ...
    testWidgets('User Journey: Completed transcription allows viewing and deleting',
        (WidgetTester tester) async {
      final completedTranscription = PodcastTranscriptionResponse(
        id: 1,
        episodeId: 1,
    ...
    testWidgets('User Journey: Transcription with missing stats still shows completion',
        (WidgetTester tester) async {
    ...
    testWidgets('Visual Journey: Progress indicators update correctly through stages',
        (WidgetTester tester) async {
      final stages = [
        {'status': 'downloading', 'progress': 10.0, 'icon': 'Download'},
        {'status': 'converting', 'progress': 30.0, 'icon': 'Convert'},
        {'status': 'transcribing', 'progress': 50.0, 'icon': 'Split'}, // Early transcribing shows Split
      ...
      for (final stage in stages) {
        ...
        final progressText = '${(stage['progress'] as double).toStringAsFixed(0)}%';
    ...
    testWidgets('UX Journey: Auto-transcription hint is shown to users', (WidgetTester tester) async {
      await tester.pumpWidget(
        MaterialApp(
          theme: AppTheme.lightTheme,
          home: Scaffold(
